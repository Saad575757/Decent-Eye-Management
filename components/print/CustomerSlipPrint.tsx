...
export function CustomerSlipPrint({ slip }: { slip: SlipData }) {
  return (
    <div className="-ml-[20mm] w-[60mm] bg-white px-3 py-2 text-black">
      ...
      <div className="mt-3 flex items-start justify-center gap-5 text-black">
        ...
        <div className="flex flex-col items-center gap-0.5">
          ...
          <span className="text-[8px]">TikTok</span>
        </div>
      </div>
    </div>
  );
